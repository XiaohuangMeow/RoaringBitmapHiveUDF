...
public class TestRoaringBitmapAndAgg {

    @Test
    public void testRoaringBitmapAndAggNormal() throws HiveException {
        RoaringBitmapAndAgg rb_and_agg=new RoaringBitmapAndAgg();

        //part1
        GenericUDAFEvaluator eval1=rb_and_agg.getEvaluator(
        ...
        // part2
        GenericUDAFEvaluator eval2=rb_and_agg.getEvaluator(
                new TypeInfo[]{TypeInfoFactory.binaryTypeInfo}
        );
        ...
        GenericUDAFEvaluator eval3=rb_and_agg.getEvaluator(
                new TypeInfo[]{TypeInfoFactory.binaryTypeInfo}
        );
        ...
        expectedBitmap.addRange(18L,20L);
        assertEquals(expectedBitmap,resultBitmap);
    }


    @Test
    public void testRoaringBitmapAndAggEmpty() throws HiveException {
        RoaringBitmapAndAgg rb_and_agg=new RoaringBitmapAndAgg();
    ...
    @Test
    public void testRoaringBitmapAndAggNull() throws HiveException {
        RoaringBitmapAndAgg rb_and_agg=new RoaringBitmapAndAgg();
