...
public class TestRoaringBitmapOrAgg {

    @Test
    public void testRoaringBitmapOrAggNormal() throws HiveException {
        RoaringBitmapOrAgg rb_or_agg=new RoaringBitmapOrAgg();

        //part1
        GenericUDAFEvaluator eval1=rb_or_agg.getEvaluator(
        ...
        // part2
        GenericUDAFEvaluator eval2=rb_or_agg.getEvaluator(
                new TypeInfo[]{TypeInfoFactory.binaryTypeInfo}
        );
        ...
        bitmap_b1.addRange(-10L,-1L);
        bitmap_b2.addRange(-20L,-5L);
        ...
        expectedBitmap2.addRange(-20L,-1L);
        ...
        expectedBitmap.addRange(1L,40L);
        expectedBitmap.addRange(-20L,-1L);
        assertEquals(expectedBitmap,resultBitmap);
    }


    @Test
    public void testRoaringBitmapOrAggEmpty() throws HiveException {
        RoaringBitmapOrAgg rb_or_agg=new RoaringBitmapOrAgg();
    ...
    @Test
    public void testRoaringBitmapOrAggNull() throws HiveException {
        RoaringBitmapOrAgg rb_or_agg=new RoaringBitmapOrAgg();
