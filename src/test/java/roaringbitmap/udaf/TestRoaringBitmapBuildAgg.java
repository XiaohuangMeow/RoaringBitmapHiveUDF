...
public class TestRoaringBitmapBuildAgg {

    @Test
    public void testRoaringBitmapBuildAggNormal() throws HiveException {
        RoaringBitmapBuildAgg rb_build_agg=new RoaringBitmapBuildAgg();

        //part1
        GenericUDAFEvaluator eval1=rb_build_agg.getEvaluator(
        ...
        // part2
        GenericUDAFEvaluator eval2=rb_build_agg.getEvaluator(
                new TypeInfo[]{TypeInfoFactory.longTypeInfo}
        );
        ...
        GenericUDAFEvaluator eval3=rb_build_agg.getEvaluator(
                new TypeInfo[]{TypeInfoFactory.longTypeInfo}
        );
    ...
    @Test
    public void testRoaringBitmapBuildAggNull() throws HiveException {
        RoaringBitmapBuildAgg rb_build_agg=new RoaringBitmapBuildAgg();
