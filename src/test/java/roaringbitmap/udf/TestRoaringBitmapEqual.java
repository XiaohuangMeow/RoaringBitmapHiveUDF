...
public class TestRoaringBitmapEqual {

    @Test
    public void testRoaringBitmapEqualNull() throws HiveException {
        RoaringBitmapEqual udf = new RoaringBitmapEqual();
    ...
    @Test
    public void testRoaringBitmapEqualEmpty() throws HiveException {
        RoaringBitmapEqual udf = new RoaringBitmapEqual();
        ObjectInspector arg1OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
        ObjectInspector arg2OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
    ...
    @Test
    public void testRoaringBitmapEqualTrue() throws HiveException {
        RoaringBitmapEqual udf = new RoaringBitmapEqual();
        ObjectInspector arg1OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
        ObjectInspector arg2OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
    ...
    @Test
    public void testRoaringBitmapEqualFalse() throws HiveException {
        RoaringBitmapEqual udf = new RoaringBitmapEqual();
        ObjectInspector arg1OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
        ObjectInspector arg2OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
