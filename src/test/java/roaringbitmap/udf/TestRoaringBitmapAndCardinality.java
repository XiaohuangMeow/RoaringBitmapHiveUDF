...
public class TestRoaringBitmapAndCardinality {

    @Test
    public void testRoaringBitmapAndCardinalityNull() throws HiveException {
        RoaringBitmapAndCardinality udf = new RoaringBitmapAndCardinality();
    ...
    @Test
    public void testRoaringBitmapAndCardinalityNormal() throws HiveException {
        RoaringBitmapAndCardinality udf = new RoaringBitmapAndCardinality();
        ObjectInspector arg1OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
        ObjectInspector arg2OI= PrimitiveObjectInspectorFactory.writableBinaryObjectInspector;
