...
public class RoaringBitmapXorCardinality extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_xor_cardinality",2,2,ObjectInspector.Category.PRIMITIVE,"bigint");
