...
public class RoaringBitmapIntersect extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_intersect",2,2,ObjectInspector.Category.PRIMITIVE,"boolean");
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        bitmap1.and(bitmap2);
        return new BooleanWritable(!bitmap1.isEmpty());
    }
}
