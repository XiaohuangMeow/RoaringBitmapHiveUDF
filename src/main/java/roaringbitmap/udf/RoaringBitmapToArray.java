...
public class RoaringBitmapToArray extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_to_array",1,1,ObjectInspector.Category.LIST,"Array<Bigint>");
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        List<LongWritable> res= Arrays.stream(bitmap.toArray())
                .mapToObj(LongWritable::new)
