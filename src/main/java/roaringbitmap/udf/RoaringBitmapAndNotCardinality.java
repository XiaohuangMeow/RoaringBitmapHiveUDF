...
public class RoaringBitmapAndNotCardinality extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_andnot_cardinality",2,2,ObjectInspector.Category.PRIMITIVE,"bigint");
