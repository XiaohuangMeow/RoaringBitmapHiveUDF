...
public class RoaringBitmapAndNot extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_andnot",2,2,ObjectInspector.Category.PRIMITIVE,"binary");
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        return RoaringBitmapSerializer.serialize(bitmap1);
    }
}
