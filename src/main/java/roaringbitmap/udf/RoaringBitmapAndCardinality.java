...
public class RoaringBitmapAndCardinality extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_and_cardinality",2,2,ObjectInspector.Category.PRIMITIVE,"bigint");
