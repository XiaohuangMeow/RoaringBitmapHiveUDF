...
public class RoaringBitmapIsEmpty extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_is_empty",1,1,ObjectInspector.Category.PRIMITIVE,"boolean");
