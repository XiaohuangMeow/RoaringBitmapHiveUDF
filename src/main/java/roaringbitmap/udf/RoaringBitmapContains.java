...
public class RoaringBitmapContains extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_contains",2,2,ObjectInspector.Category.PRIMITIVE,"boolean");
    ...
    public Object evaluate(DeferredObject[] deferredObjects) throws HiveException {
        ...
        bitmap2.andNot(bitmap1);
        return new BooleanWritable(bitmap2.isEmpty());
    }
}
