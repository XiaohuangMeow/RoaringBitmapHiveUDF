...
public class RoaringBitmapEqual extends AbstractGenericUDFRoaringBitmapBase{

    @Override
    public ObjectInspector initialize(ObjectInspector[] objectInspectors) throws UDFArgumentException {
        initFunctionParameters("rb_equal",2,2,ObjectInspector.Category.PRIMITIVE,"boolean");
