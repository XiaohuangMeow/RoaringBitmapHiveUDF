...
public class RoaringBitmapOrAgg extends AbstractGenericUDAFRoaringBitmapResolver {
    @Override
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws UDFArgumentTypeException {
        checkArgSize(1,parameters);
        checkArgType("rb_or_agg",0,parameters, PrimitiveObjectInspector.PrimitiveCategory.BINARY);
        return new RoaringBitmapOrAggEvaluator();
    }

    public static class RoaringBitmapOrAggEvaluator extends AbstractGenericUDAFRoaringBitmapEvaluator {
